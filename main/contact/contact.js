const ContactPage = () => {
    async function init() {
        ...
        const grid = div({ id: 'contact_grid' })
            ...
            .append(elem({ tag: 'h1', text: 'Visit' }), paragraph({ cls: 'subtitle', text: 'Address' }), anchor({ href: `https://goo.gl/maps/wmR4cYfhDRwgM1m59`, text: address }).target("_blank")), div({ cls: 'call' })
            .append(elem({ tag: 'h1', text: 'Call' }), paragraph({ cls: 'subtitle', text: "9am - 17pm Su - Th" }), anchor({ text: '(+972)3-6406980', href: `tel:(+972)3-6406980` }).target("_blank")), div({ cls: 'email' })
            .append(elem({ tag: 'h1', text: 'Email' }), anchor({
